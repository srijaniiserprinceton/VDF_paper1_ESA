...
class VDF_rec_polarcaps_SphericalHarmonics:
    def __init__(self, DATA, StepI_bundle, time_idx, SH_basis, Lmax=12, rcond=0.0, makeplot=True):
        self.DATA = DATA
        self.time_idx = time_idx
        self.SH_hr = SH_basis
