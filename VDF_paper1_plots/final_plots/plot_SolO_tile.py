...
plt.subplots_adjust(left=0.06, right=0.97, hspace=0.05, wspace=0.05, top=0.93)
...
text1 = plt.text(s='SolO-PAS observation', x=0.18, y=0.95, transform=fig.transFigure)
...
plt.savefig('Eshell_plots_SolO.pdf')
...
ax[0].set_title('(C1) SolO-PAS data', fontsize=12, fontweight='bold')
...
plt.savefig('moment_rec_comparison_SolO.pdf')